window.MOFFL_HQ = {
  ...
  "importantDates": [
    ...
    {
      "id": "DATE002",
      "type": "Keeper Deadline",
      "title": "2027 Keeper Deadline",
      "date": "",
      "time": "",
      "location": "",
      "status": "TBD",
  ...
  "announcements": [
    {
      "id": "ANN001",
      "title": "Rule Proposals Are Open",
      "category": "Governance",
      "priority": "High",
      "status": "Active",
      "body": "GMs can now prepare proposed rule changes for discussion at the next season's draft using the proposal portal on the Constitution page."
    },
    {
      "id": "ANN002",
      "title": "2027 Offseason Planning",
      "category": "League",
      "priority": "Normal",
      "status": "Active",
  ...
  "ruleProposal": {
    "officialFormUrl": "https://forms.gle/7qz33LXtwgsvDMXY9",
    "submissionEmail": "",
